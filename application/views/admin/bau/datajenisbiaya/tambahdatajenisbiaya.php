...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
            <p class="mb-4"><i class="fas fa-home"></i><a href="<?php echo base_url('admin/dashboard') ?>"> Halaman Utama</a> / <a href="<?php echo base_url('admin/bau/datajenisbiaya') ?>"> Managemen Jenis Biaya </a> / <strong> Tambah Jenis Biaya</strong> </p>
            </div>

<!-- DataTales Example -->
<div class="card shadow mb-4" >
    <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-primary">Tambah Jenis Biaya</h5>
            ...
            <div class="card" style="width: 100%; margin-bottom: 100px ">
            	<div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis_komponen" class="form-control mb-3">
