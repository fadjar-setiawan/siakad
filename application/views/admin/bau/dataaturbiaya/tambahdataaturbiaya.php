...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
            <p class="mb-4"><i class="fas fa-home"></i><a href="<?php echo base_url('admin/dashboard') ?>"> Halaman Utama</a> / <a href="<?php echo base_url('admin/bau/dataaturbiaya') ?>"> Managemen Komponen Biaya </a> / <strong>Tambah Komponen Biaya</strong> </p>
            </div>
        ...
        <div class="table-responsive">
            ...
            <div class="card" style="width: 100%; margin-bottom: 100px ">
            	<div class="card-body">
            		...
            		<form method="POST" action="<?php echo base_url('admin/bau/dataaturbiaya/tambahdataaksi') ?>" enctype="multipart/form-data">

                        <div class="form-group">
                              <label>Master Biaya</label>
                              <select name="kd_master_biaya" class="form-control">
                    ...
                    <div class="form-group">
                              ...
                              <select name="model_pembayaran" class="form-control">
